...
class FilterIndex
{
    public:
        ...
        vector<uint32_t> findNearestNeighbor(float* query, vector<string> props, int num_results, int max_num_distances, int m);
        ...
        vector<vector<string>> ClusterProperties;//properties of each cluster
        uint32_t d, nb, nc, k;
